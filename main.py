...
def analisar_estatisticas(fixture_id, home_team, away_team, minuto, gols_casa, gols_fora):
    ...
    try:
        ...
        # FILTRO DE SEGURANÇA: Mínimo de 10 faltas no 1T para disparar o alerta
        if faltas_totais < 10:
